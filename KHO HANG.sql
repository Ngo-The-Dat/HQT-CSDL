...
BEGIN
    ALTER DATABASE KHOHANG SET SINGLE_USER WITH ROLLBACK IMMEDIATE
    DROP DATABASE KHOHANG
END
GO
...
ALTER TABLE NHANVIEN ADD CONSTRAINT FK_MAQL FOREIGN KEY(MAQL) REFERENCES NHANVIEN(MANV)
...
('NV02', N'Lê Tấn Phong', N'Báng hàng'),
('NV03', N'Trần Văn Cường', N'Quản lý'),
('NV04', N'Phạm Thị Dung', N'Nhân viên kho'),
('NV05', N'Lê Thị Bình', N'Kế toán');
GO
